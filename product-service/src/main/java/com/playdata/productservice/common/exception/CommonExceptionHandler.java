package com.playdata.productservice.common.exception;

import com.playdata.productservice.common.dto.CommonErrorDto;
...
public class CommonExceptionHandler {
    ...
    public ResponseEntity<?> illegalHandler(
    ...
    public ResponseEntity<?> authDeniedHandler(
            EntityNotFoundException e) {
        e.printStackTrace();
